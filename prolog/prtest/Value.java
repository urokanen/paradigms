...
public final class Value {
    ...
    public boolean equals(final Object that) {
        return this == that || that instanceof Value v && term.equals(v.term);
    }
    ...
    public static Value convert(final Object term) {
        ...
        } else if (term instanceof Term t) {
            return term(t);
        } else if (term instanceof List<?> l) {
            return list(l, Value::convert);
        } else if (term instanceof Map.Entry<?, ?> e) {
            return entry(e);
        } else if (term instanceof Map<?, ?> m) {
            final List<Value> items = m.entrySet().stream()
                    .map(Value::entry)
